        ...
        <div class="container" style="margin-top: 30px;">
            ...
            <div class="row">
                <div class="section-header">
                    <h2 class="people-heading">Officers and Staffs</h2>
                </div>
            </div>
            <!-- /row -->

            <?php
                    $len = sizeof($staff_names);
                    $html = "";
                    for($i=0; $i<$len; $i++){
                        $card = "<div class=\"card mb-3 m-2\" style=\"max-width: 540px;\">
                                    <div class=\"row g-0\">
                                        <div class=\"col-md-4\">
                                            <a href=\"#\"> <img src=\"$staff_img_links[$i]\". class=\"img-fluid rounded-start\" alt=\"...\"></a>
                                         </div>
        
                                        <div class=\"col-md-8\">
                                             <div class=\"card-body\">
                                                <h4 class=\"card-title\"><a href=\"#\">$staff_names[$i]</a></h4>
                                                <p class=\"card-title\">$staff_designations[$i]</p>
                                                <p class=\"card-title\">Phone: $staff_phones[$i]</p>
                                                <p class=\"card-title\">Email: $staff_emails[$i]</p>
                                                <p class=\"card-text\"><small class=\"text-body-secondary\"><a href=\"#\">See details...</a></small></p>
                                            </div>
                                        </div>
