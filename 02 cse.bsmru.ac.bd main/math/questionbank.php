<?php
    ...
    if(!is_numeric($id)){
        header("Location: questionbank?deg=1"); 
        exit;
    }
    ...
    $sql = "SELECT * FROM question_banks WHERE degree_id = " . $id;
...
<head>
    <?php
        ...
        include('assets/Views/questionbankview.php');
    ?>
...
<body>
    ...
    <?php
        if($num_rows < 1){
            echo '<h2 style="text-align: center; margin-top: 40px;">No Question Bank Found For '.$program.' Program</h2>';
        }
        else{
            echo '
                <!-- Title Starts-->
                <div class="container section-header" id="title-container">
                    ...
                    <div class = "col-md-12" style = "text-align: center">
                        <h2 >Question bank of '.$program.' Program</h2>
                    </div>
                    </div>
                </div>
                <!-- Title Ends -->
