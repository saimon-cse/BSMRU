                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src="{{ url('upload/admin_images/' . $profileData->photo) }}" alt="Profile"
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                {{-- <li class="nav-item">
                                    <button class="nav-link" data-bs-toggle="tab"
                                        data-bs-target="#profile-settings">Academics & Experiences</button>
                                </li> --}}
                                    ...
                                    <form method="POST" action="{{ route('admin.profile.store') }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <img id="imagePreview" src="{{ !empty($profileData->photo) ? url('upload/admin_images/' . $profileData->photo) : url('upload/admin_images/no_image.png') }}" alt="Profile" style="width: 150px; height: 150px;">
                                                <div class="pt-2">
                                                    <div class="col-sm-4">
                                                        <input class="form-control" type="file" id="formFile" name="photo" onchange="previewImage();">
                                                    </div>
                        ...
                        <!-- End Quill Editor Default -->
                                        ...
                                        <div class="row mb-3">
                                            <label for="Research Interest"
                                                class="col-md-4 col-lg-3 col-form-label">Research Interest</label>
                                            <div class="col-md-8 col-lg-9">
                                                <!-- Quill Editor Default -->
                                ...
                                <div class="tab-pane fade pt-3" id="profile-settings">
                                    ...
                                    {{-- <div class="card">
                                        <div class="d-inline-flex">
                                            <a href="{{ route('addEducation') }}" class="btn btn-primary"
                                            style="width: 180px">Add Education</a>

                                            <a href="{{ route('addExperience') }}" class="btn btn-success"
                                            style="width: 180px">Add Experience</a>


                                            <a href="{{ route('addAward') }}" class="btn btn-primary"
                                            style="width: 180px">Add Award</a>
...
<script>
    function previewImage() {
        ...
        if (file) {
            ...
            document.getElementById("imagePreview").src = "{{ url('upload/admin_images/no_image.png') }}";
        }
    }
    </script>
    {{-- end preview --}}
