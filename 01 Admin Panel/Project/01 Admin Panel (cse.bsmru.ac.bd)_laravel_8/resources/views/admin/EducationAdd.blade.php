            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{route('StoreEducation')}}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" name="degree" require placeholder="Name of Degree">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputText" name="university" placeholder="University" require>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputText" name="passYear" placeholder="Passing Year" require>
                    </div>
                  </div>
