                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('admin.noticeRankup', ['id' => $notice->id]) }}"><i class="bx bxs-upvote">Up</i></a>
                      <a href="{{ route('admin.noticeRankDown', ['id' => $notice->id]) }}"><i class="bx bxs-downvote">Down</i></a>
                  </td>
