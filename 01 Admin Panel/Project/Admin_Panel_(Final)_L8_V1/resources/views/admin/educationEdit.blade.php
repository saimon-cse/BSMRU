    ...
    <main id="main" class="main">
        <div class="card">
            ...
            @endif
                ...
                <form action="{{ route('EditedEducation', ['id' => $education->id]) }}" onsubmit="sanitizeInputs()">
                    @csrf
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Degree</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="degree" required value="{{ $education->degree }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="passYear" required value="{{ $education->passYear }}">
                        </div>
                    </div>
                    {{--
                          <div class="row mb-3">
