...
===================================================*/
    ...
    public function update(Request $request, $notice)
    {
        ...
        // Log user action
        Log::channel('custom_log')->info('AdminNoticeEdited: User ID ' . Auth::user()->user_id . ' edited notice ID ' . $notice);
    ...
    public function destroy($notice)
    {
        ...
        // Log user action
        Log::channel('custom_log')->info('NoticeDelete: User ID ' . Auth::user()->user_id . ' deleted notice ID ' . $notice);
